      ...
      {/* <header className="px-6 py-4 border-b border-gray-800">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <span className="text-[#BB86FC] text-2xl font-bold">BrainScan</span>
          </div>
              ...
              <div className="space-y-6">
                {aboutPoints.map((point, index) => (
                  <div key={index} className="flex gap-3">
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#BB86FC] bg-opacity-20 flex items-center justify-center text-[#BB86FC] font-bold">
                      {index + 1}
                    </div>
                    <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-[#1E1E1E] rounded-xl p-6 shadow-lg border border-gray-800 hover:border-[#BB86FC] transition-all duration-300 hover:translate-y-[-5px]">
                <div className="w-14 h-14 rounded-full bg-[#BB86FC] bg-opacity-20 flex items-center justify-center text-[#BB86FC] mb-6">
              ...
              {steps.map((step, index) => (
                <div key={index} className="relative grid md:grid-cols-2 gap-8 items-center">
                  <div className={`md:pr-16 ${index % 2 === 1 ? 'md:order-2' : ''}`}>
                    <div className="absolute top-0 left-[50%] w-12 h-12 rounded-full bg-[#BB86FC] flex items-center justify-center text-[#121212] font-bold transform -translate-x-1/2 md:block hidden">
                      {index + 1}
                    </div>
              ...
              <div key={index} className="bg-[#1E1E1E] rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:translate-y-[-5px]">
                <div className="md:flex">
                  <div className="md:w-1/3 p-6 flex justify-center items-center">
                    <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[#BB86FC]">
                      <img 
                        src={member.image || "https://via.placeholder.com/150?text=" + member.name.charAt(0)} 
                        alt={member.name}
                  ...
                  <div className="md:w-2/3 p-6">
                    ...
                    <p className="text-gray-400">{member.bio || "Research expert combining medical knowledge with AI technology to advance Alzheimer's detection."}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="md:flex md:justify-between">
            <div className="mb-8 md:mb-0">
              <h3 className="text-[#BB86FC] text-2xl font-bold mb-4">BrainScan</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="text-gray-400">contact@brainscan.ai</li>
                  <li className="text-gray-400">+1 (888) 123-4567</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-center md:flex md:justify-between md:text-left">
            <p className="text-gray-500">&copy; 2025 BrainScan AI. All rights reserved.</p>
            <p className="text-gray-500 mt-2 md:mt-0">Created by Purva Chavan & Sanika Salvi</p>
          </div>
        </div>
      </footer>
    </div>
